...
class SteroCameraNode:
    ...
    def init_bindings(self):
        ...
        rospy.Subscriber("/zedm/zed_node/right/image_rect_color", Image, self.r_img_callback)
        rospy.Subscriber("/zedm/zed_node/right/image_rect_color", Image, self.l_img_callback)
